...
const signs = [
  {
    icon: "RefreshCw",
    text: "Вы снова и снова попадаете в одни и те же ситуации — в отношениях, работе, деньгах",
  },
  {
    icon: "VolumeX",
  ...
  {
    icon: "UserX",
    text: "Сложно принять себя — сравниваете, осуждаете, требуете от себя невозможного",
  },
  {
    icon: "TrendingDown",
        ...
        >
          <div className="flex-1">
            ...
            <p className="font-golos text-forest-700 leading-relaxed">
              Без работы с этим слоем любой новый старт рано или поздно упирается в то же самое. Не потому что вы «слабые» — а потому что инструмент не тот.
            </p>
          </div>
