...
const plans = [
  {
    ...
    features: [
      ...
      "Одна личная встреча для диагностики сценариев и корректировки",
      "Корректировка до 2 сценариев за курс",
    ],
  ...
  },
  {
    ...
    features: [
      "10 индивидуальных сессий (по 60 мин)",
      "Глубокая работа с корневыми сценариями",
      "Поддержка на протяжении всего курса",
      "Персональные практики и задания",
      "Две личные встречи для диагностики сценариев и корректировки",
      "Корректировка до 4 сценариев за курс",
      "Бонус! Живые обои на телефон, полная корреляция с новыми Сценариями 🎯",
    ],
